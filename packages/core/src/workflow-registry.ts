...
const TRIGGER_ENTRIES: NodeRegistryEntry[] = [
  {
    type: "trigger", subtype: "pr_opened", name: "PR Opened", category: "Triggers",
    ...
    params: [], handles: triggerHandles,
  },
  {
    type: "trigger", subtype: "pr_edited", name: "PR Edited", category: "Triggers",
  ...
  {
    type: "trigger", subtype: "issue_opened", name: "Issue Opened", category: "Triggers",
  ...
  {
    type: "trigger", subtype: "issue_edited", name: "Issue Edited", category: "Triggers",
  ...
  {
    type: "trigger", subtype: "comment_created", name: "Comment Created", category: "Triggers",
  ...
  {
    type: "trigger", subtype: "contributor_first_interaction", name: "First Interaction", category: "Triggers",
  ...
  {
    type: "trigger", subtype: "schedule", name: "Schedule", category: "Triggers",
    ...
    params: [
      {
        key: "scheduleType", name: "Run frequency", type: "select", required: true, default: "daily",
        options: [
      ...
      { key: "minutesInterval", name: "Interval (minutes)", type: "number", default: 15, description: "Run every N minutes", condition: { field: "scheduleType", value: "minutes" } },
      { key: "hourlyMinute", name: "Minute", type: "number", default: 0, description: "Minute of the hour (0-59)", condition: { field: "scheduleType", value: "hourly" } },
      { key: "dailyTime", name: "Time", type: "string", default: "09:00", description: "Time of day (HH:MM)", condition: { field: "scheduleType", value: "daily" } },
      {
        key: "weeklyDay", name: "Day of week", type: "select", default: "MON",
        options: [
      ...
      { key: "weeklyDayTime", name: "Time", type: "string", default: "09:00", description: "Time of day (HH:MM)", condition: { field: "scheduleType", value: "weekly" } },
      { key: "cronExpression", name: "Cron expression", type: "string", description: "Standard 5-field cron (e.g. 0 9 * * MON)", condition: { field: "scheduleType", value: "custom" } },
      {
        key: "timezone", name: "Timezone", type: "select", default: "UTC",
        options: [
          { label: "UTC", value: "UTC" },
        ...
        condition: { field: "scheduleType", value: ["daily", "weekly", "custom"] },
      },
    ],
    handles: triggerHandles,
  },
  {
    type: "trigger", subtype: "schedule_daily", name: "Daily Schedule", category: "Triggers",
    description: "Fires once per day on a schedule",
    params: [], handles: triggerHandles, hidden: true,
  },
  {
    type: "trigger", subtype: "schedule_weekly", name: "Weekly Schedule", category: "Triggers",
    description: "Fires once per week on a schedule",
    params: [], handles: triggerHandles, hidden: true,
  },
  {
    type: "trigger", subtype: "manual", name: "Manual Run", category: "Triggers",
  ...
  {
    type: "trigger", subtype: "repo_scan", name: "Repo History Scan", category: "Triggers",
...
const CONDITION_ENTRIES: NodeRegistryEntry[] = [
  {
    ...
    params: [
      {
        key: "field", name: "Field", type: "select", required: true, default: "score",
        options: [
...
const LOGIC_ENTRIES: NodeRegistryEntry[] = [
  {
    type: "logic", subtype: "AND", name: "AND Gate", category: "Logic Gates",
    ...
    params: [{ key: "gate", name: "Gate", type: "string", default: "AND" }], handles: logicHandles,
  },
  {
    type: "logic", subtype: "OR", name: "OR Gate", category: "Logic Gates",
    ...
    params: [{ key: "gate", name: "Gate", type: "string", default: "OR" }], handles: logicHandles,
  },
  {
    type: "logic", subtype: "NOT", name: "NOT Gate", category: "Logic Gates",
    ...
    params: [{ key: "gate", name: "Gate", type: "string", default: "NOT" }], handles: logicHandles,
  },
];

const ACTION_ENTRIES: NodeRegistryEntry[] = [
  {
    type: "action", subtype: "block", name: "Block", category: "Actions",
    ...
    params: [{ key: "message", name: "Message", type: "string", description: "Optional message to include when blocking" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "warn", name: "Warn", category: "Actions",
    ...
    params: [{ key: "message", name: "Message", type: "string", description: "Warning message text" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "log", name: "Log Event", category: "Actions",
    ...
    params: [{ key: "message", name: "Message", type: "string", description: "Log message" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "close", name: "Close", category: "Actions",
    ...
    params: [], handles: actionHandles,
  },
  {
    type: "action", subtype: "label", name: "Add Label", category: "Actions",
    ...
    params: [{ key: "label", name: "Label", type: "string", required: true, description: "Label name to add" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "comment", name: "Comment", category: "Actions",
    ...
    params: [{ key: "message", name: "Message", type: "string", required: true, description: "Comment body text" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "add_to_whitelist", name: "Whitelist", category: "Actions",
  ...
  {
    type: "action", subtype: "add_to_blacklist", name: "Blacklist", category: "Actions",
  ...
  {
    type: "action", subtype: "remove_from_whitelist", name: "Remove Whitelist", category: "Actions",
  ...
  {
    type: "action", subtype: "remove_from_blacklist", name: "Remove Blacklist", category: "Actions",
  ...
  {
    type: "action", subtype: "notify_slack", name: "Notify Slack", category: "Actions",
    ...
    params: [{ key: "url", name: "Webhook URL", type: "string", required: true, description: "Slack incoming webhook URL" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "notify_discord", name: "Notify Discord", category: "Actions",
    ...
    params: [{ key: "url", name: "Webhook URL", type: "string", required: true, description: "Discord webhook URL" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "send_webhook", name: "Send Webhook", category: "Actions",
    ...
    params: [{ key: "url", name: "Webhook URL", type: "string", required: true, description: "Target URL for the webhook POST" }], handles: actionHandles,
  },
  {
    type: "action", subtype: "request_review", name: "Request Review", category: "Actions",
...
const TRANSFORM_ENTRIES: NodeRegistryEntry[] = [
  {
    type: "transform", subtype: "fetch_github_user", name: "Fetch GitHub User", category: "Transforms",
    description: "Enrich the workflow context with the contributor's GitHub profile data",
    ...
    params: [], handles: transformHandles,
  },
  {
    type: "transform", subtype: "compute_score", name: "Compute Score", category: "Transforms",
  ...
  {
    type: "transform", subtype: "fetch_pr_files", name: "Fetch PR Files", category: "Transforms",
  ...
  {
    type: "transform", subtype: "scan_history", name: "Scan History", category: "Transforms",
  ...
  {
    type: "transform", subtype: "detect_language", name: "Detect Language", category: "Transforms",
