...
export const TRIPWIRE_EYE_SOCKET_VIEWBOX: readonly [number, number] = [100.02, 50.72];
...
export const TRIPWIRE_EYE_PUPIL_VIEWBOX: readonly [number, number] = [30.59, 30.96];
...
export const TRIPWIRE_EYE_SOCKET_RECT_IN_OUTER: readonly [number, number, number, number] = [
	57.89, 59.46, 99.83, 50.65,
];
export const TRIPWIRE_EYE_PUPIL_RECT_IN_OUTER: readonly [number, number, number, number] = [
