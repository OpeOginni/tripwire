...
export function HeroStatSparklineGraphic({ className }: { className?: string }): React.ReactElement {
	return (
		<svg width="256" height="78" viewBox="0 0 256 78" className={className} aria-hidden>
			<defs>
