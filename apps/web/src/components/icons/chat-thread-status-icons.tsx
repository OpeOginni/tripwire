...
export function ChatErrorAlertIcon14({ className }: { className?: string }): React.ReactElement {
	return (
...
export function ToolStepErrorRingIcon12({ className }: { className?: string }): React.ReactElement {
	return (
...
export function ToolStepSuccessRingIcon12({ className }: { className?: string }): React.ReactElement {
	return (
		<svg width="12" height="12" viewBox="0 0 12 12" fill="none" className={className} aria-hidden>
			<circle cx="6" cy="6" r="5" stroke="currentColor" strokeWidth="1.2" />
...
export function ThoughtCollapsibleChevronIcon10({ className }: { className?: string }): React.ReactElement {
	return (
...
export function BatchResultSuccessRingIcon14({ className }: { className?: string }): React.ReactElement {
	return (
		<svg width="14" height="14" viewBox="0 0 14 14" fill="none" className={className} aria-hidden>
			<circle cx="7" cy="7" r="6" stroke="currentColor" strokeWidth="1.2" />
...
export function BatchResultErrorRingIcon14({ className }: { className?: string }): React.ReactElement {
	return (
		<svg width="14" height="14" viewBox="0 0 14 14" fill="none" className={className} aria-hidden>
			<circle cx="7" cy="7" r="6" stroke="currentColor" strokeWidth="1.2" />
