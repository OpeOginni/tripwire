				...
				<div className="flex items-center gap-1 bg-tw-card rounded-[10px] p-1">
					{([
						...
						<Button variant="ghost"
							...
							className={`flex items-center gap-1.5 h-7 px-2.5 rounded-[6px] text-[12px] font-medium transition-colors cursor-pointer ${subtab === key
			...
			{subtab === "vouched" ? (
				...
				<>
					...
					<div className="flex items-center gap-2 -mt-1.5 px-1">
						<PeopleListShieldHintIcon13 variant={subtab === "block" ? "block" : "allow"} />
			...
			<div className="rounded-[10px] bg-tw-card p-1">
				<div className="flex items-center gap-2 h-9 px-2.5">
					...
					<Button variant="ghost"
						...
						onClick={handleAdd}
						className={`h-7 px-2.5 rounded-[6px] text-[12px] font-medium flex items-center gap-1 transition-colors cursor-pointer ${username.trim()
