	...
	return (
		<div ref={containerRef} className="relative" style={{ width: size, height: containerHeight }}>
			...
			>
				...
				>
					<path d="M15.2,0C7.79.19,0,5.32,0,15.38c0,7.6,5.7,15.58,15.58,15.58,8.93,0,15.01-6.46,15.01-15.2S24.32.19,15.2,0Z" />
				</svg>
			</div>
		</div>
	);
